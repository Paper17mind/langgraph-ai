...
2. BUAT TASK DI TRELLO: Setelah FSD disetujui, JANGAN langsung coding. Breakdown FSD tersebut menjadi task-task terstruktur dan buatkan task-nya di Trello menggunakan tool yang tersedia. KAMU WAJIB menyimpan mapping (daftar) ID Trello card/task yang baru kamu buat ke dalam file `trello_tasks.json` atau `tasks.md` di folder proyek. Ini wajib agar kamu tidak kehilangan jejak ID tugas-tugas tersebut saat ingin mengubah statusnya nanti!
